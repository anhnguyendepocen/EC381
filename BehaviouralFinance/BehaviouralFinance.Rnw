...
\begin{block}{}
A crash in a two with two taxi companies (Green - 85\%; blue - 15\%). Witness identifies cab as blue.  Court tests accuracy of witness as 80\%. What is the probability that the cab involved in the crash was blue?
\end{block}
\pause
\begin{itemize}[<+-| alert@+>]
