...
\item Period of calm and crisis
\end{itemize}
\end{itemize}
\pause
Probably better to think of a \emph{spectrum of efficiency}: from more to less efficiency depending on place and time
\end{frame}
